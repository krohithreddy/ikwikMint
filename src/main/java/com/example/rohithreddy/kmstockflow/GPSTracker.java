...
/**
 * Created by rohith reddy on 6/22/2017.
 */
    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
               ...
               // System.out.println("on your gps");
//                Toast.makeText(getBaseContext(), "on your gps",
  //                      Toast.LENGTH_SHORT).show();
            } else {
                this.canGetLocation = true;
                // First get location from Network Provider
             //   System.out.println("on sfagdeee gps");
                if (isNetworkEnabled) {
                 //   System.out.println("n on");
//                    Toast.makeText(getBaseContext(), "network is on",
  //                          Toast.LENGTH_SHORT).show();
